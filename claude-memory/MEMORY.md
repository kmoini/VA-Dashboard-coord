...
- [Checkpoint rule](checkpoint-rule.md) — commit checkpoint-NNN + annotated tag + push both. ⚠️ derive NNN from live `git tag` after fetch (shared repo). Latest: 168 (2026-07-23 AI cost + token In/Out split).
